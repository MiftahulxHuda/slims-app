...
import FilterGMD from '../components/gmd/FilterGMD';
import { COLORS, FONTS, SIZES } from '../constants';
import { setInitialValues, resetFilter } from '../store/slice/filterGMDSlice';
import { setModalVisible } from '../store/slice/loadingSlice';
import ButtonResetForm from '../components/commons/ButtonResetForm';

const Stack = createStackNavigator();

class GMDScreen extends Component {
  constructor(props) {
    super(props);
  }
...
function mapStateToProps(state) {
  return {
    filter: state.filterGMD.initialValues,
    isReset: state.filterGMD.isReset,
