...
import { setInitialValues, resetFilter } from '../store/slice/filterItemStatusSlice';
import { setModalVisible } from '../store/slice/loadingSlice';
import ItemStatus from '../components/item_status/ItemStatus';
import FilterItemStatus from '../components/item_status/FilterItemStatus';
...
class ItemStatusScreen extends Component {
  constructor(props) {
    super(props);
  }
...
function mapStateToProps(state) {
  return {
    filter: state.filterItemStatus.initialValues,
    isReset: state.filterItemStatus.isReset,
