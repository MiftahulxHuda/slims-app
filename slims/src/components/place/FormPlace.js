...
class MyForm extends PureComponent {
    ...
    async findOneById(id) {
        const findOneById = await CRUDService.findOneById(`${"/mst-place"}/${id}`);
        if (findOneById) {
...
const create = async (post) => {
    const created = await CRUDService.create("/mst-place", post);
    return created;
}

const updateOneById = async (id, post) => {
    const updated = await CRUDService.updateOneById("/mst-place", id, post);
    return updated;
}
